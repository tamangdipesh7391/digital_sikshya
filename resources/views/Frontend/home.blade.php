  ...
  <section id="hero">
    <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <!-- Slide 1 -->
        <div class="carousel-item active" style="background-image: url({{url('frontend/assets/img/slide/slide-1.jpg')}})">
          <div class="container">
        ...
        <!-- Slide 2 -->
        <div class="carousel-item" style="background-image: url({{url('frontend/assets/img/slide/slide-2.jpg')}})">
          <div class="container">
        ...
        <!-- Slide 3 -->
        <div class="carousel-item" style="background-image: url({{url('frontend/assets/img/slide/slide-3.jpg')}})">
          <div class="container">
  ...
  <section id="features" class="features">
    <div class="container" data-aos="fade-up">
      ...
      <div class="row">
        ...
        <div class="image col-lg-6 order-1 order-lg-2" style='background-image: url("frontend/assets/img/features.jpg");' data-aos="zoom-in"></div>
      </div>
